...
b"TMCu" 表示数字 1967344980，这种使用四个字符表示一个数字的方法叫[ 四字符代码（F](https://en.wikipedia.org/wiki/FourCC)[our-character codes](https://en.wikipedia.org/wiki/FourCC)[）](https://en.wikipedia.org/wiki/FourCC)，在 x86 平台它通常是[ 字节序#小端序 ](https://zh.wikipedia.org/wiki/%E5%AD%97%E8%8A%82%E5%BA%8F#%E5%B0%8F%E7%AB%AF%E5%BA%8F)的
